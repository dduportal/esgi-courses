...
** Clonez le dépôt avec la commande `git clone https://github.com/xxx/{student_gh_repository_name}`
** 💡 Si le dépôt n'apparaît pas dans l'"Explorer" à gauche : `code -a /workspace/{student_gh_repository_name}`
