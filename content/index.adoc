= Solutions de Déploiement Continu (CI & CD)
include::./attributes.adoc[]

[.title]
🇫🇷 link:https://www.esgi.fr/campus-lyon.html[ESGI Lyon,window="_blank"] - M2 IW S1 2024/2025
...
// Docker Advanced
include::./chapitres/docker-advanced.adoc[leveloffset=1]
