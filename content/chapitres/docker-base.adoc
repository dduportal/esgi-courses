...
image::docker_meme.jpg[caption="Docker meme",width=300]
...
1 "tâche" par conteneur

image::maison-conteneur.jpg[caption="Maison conteneur",width=300]
...
----
docker container ls
# Où est mon conteneur ? ajouter l'option --all
----
