...
* Affichez la liste des commits

* Affichez le changeset associé à un commit

* Modifiez du contenu dans `README.md` et affichez le diff
...
* Créez une branche nommée `feature/html`


* Ajoutez un nouveau commit contenant un nouveau fichier `index.html` sur cette branche


* Affichez le graphe correspondant à cette branche avec `git log --graph`
...
* Mergez la branche `feature/html` dans la branche principale
...
* `git` est un des (plus populaires) système de contrôle de versions
